...
```{r figure1, fig.width=7.1, fig.height=4, fig.path='figures/', dev=c('CairoPDF', 'CairoPS', 'tiff'), dev.args=f1_args, dpi=600}
# draw figure 1
ggarrange(f1a, 
          ggarrange(f1b, f1c, 
                    labels = c("B", "C"), 
...
```{r figure2, fig.width=7.1, fig.height=6, fig.path='figures/', dev=c('CairoPDF', 'CairoPS', 'tiff'),  dev.args=f2_args, dpi=600}
# draw figure 2
...
```{r figure3, fig.width=7.2, fig.height=6, fig.path='figures/', dev=c('CairoPDF', 'CairoPS', 'tiff'),  dev.args=f3_args, dpi=600}
# draw figure 3
...
```{r figure4, fig.width=7.1, fig.height=5, fig.path='figures/', dev=c('CairoPDF', 'CairoPS', 'tiff'),  dev.args=f4_args, dpi=600}
...
```{r figure5, fig.height=6, fig.path='figures/', dev=c('CairoPDF', 'tiff'), dev.args=f5_args, dpi=600}
...
```{r figure6, fig.width=2.5, fig.height=4, fig.path='figures/', dev=c('CairoPDF', 'CairoPS', 'tiff'), dev.args=f6_args, dpi=600}
ggarrange(f6a, f6b, 
          labels = c("A", "B"), 
          ncol = 1,
          nrow = 2)
...
```{r figure7, fig.width=4, fig.height=3.6, fig.path='figures/', dev=c('CairoPDF', 'tiff'), dev.args=f7_args, dpi=600}
...
```{r figure8, fig.width=7.2, fig.height=6, fig.path='figures/', dev=c('CairoPDF', 'tiff'), dev.args=f8_args, dpi=600}
