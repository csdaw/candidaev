...
a7a <- plot_volcano(data = a1_res, 
                    p_val = adj.P.Val, 
                    lfc = logFC,
                    grp = group, 
                    colour = c("orange", "purple"), 
                    label = ifelse(logFC >= 6, CGD_gene_name, ""))

a7b <- plot_volcano(data = a9_res, 
                    p_val = adj.P.Val, 
                    lfc = logFC,
                    grp = group, 
                    colour = c("red", "blue"), 
...
a7d <- plot_volcano(data = aw_res, 
                    p_val = adj.P.Val, 
                    lfc = logFC,
                    grp = group, 
                    colour = c("purple", "blue"), 
                    label = ifelse(logFC >= 6, CGD_gene_name, ""))
