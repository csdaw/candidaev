...
```{r figure3, fig.cap=f3_cap, fig.width=7.2, fig.height=6}
# draw figure 3
...
f5_cap <- "\\textbf{Identification of commonly enriched EV proteins across 
           ...
           exclusive to EVs from all four strains and therefore had no valid 
           log\\textsubscript{2}(FC) values
           were seperated prior to clustering, in the group designated 
           \`\`cluster 8\". Functional enrichment analyses were performed on 
           ...
           presented in the table inset. Full lists of enriched GO terms and 
           proteins in each cluster are available in supplemental Files S3 and 
           S5 respectively."
```
...
```{r figure7, fig.cap=f7_cap, fig.width=4, fig.height=3.6}
