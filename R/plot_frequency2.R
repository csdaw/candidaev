...
#' }
#'
#' @param mat numeric matrix: from which to plot protein quantification frequency
#'
#' @param plot logical:
...
#'
#' @return Returns a bar plot of the frequency of protein quantification between samples
