...
new_order <- c("5", "1", "2", "3", "4")

test14$clusterID <- gdata::reorder.factor(test14$clusterID, new.order = new_order)
...
htmp2(test6, split = test16, show_row_names = FALSE)

ggarrange(test9_grob, test17)
