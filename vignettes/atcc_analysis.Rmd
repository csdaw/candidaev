...
The patterns of missing values in `a1_both` and `a9_both` can be visualised.
...
In this case each data.frame is subset to remove all columns 
...
The `a9_htmp` heatmap is plotted with: 
...
htmp_cap <- "Protein log<sub>2</sub> LFQ intensity heatmap. Data has been 
             centred around 0. ATCC90028 proteins significantly different in 
             abundance between EV and WCL."
```
