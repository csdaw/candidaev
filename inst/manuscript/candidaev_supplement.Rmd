...
fS1_cap <- "\\textbf{Schematic of the workflow used for the isolation and 
           ...
           separate analyses were combined (step 7) to identify proteins which 
...
# export table S2 LaTeX code (to be converted to docx with Pandoc)
cat(tabS2, file = "tables/table_S2.tex", sep = "\n")
...
fS4_cap <- c("\\textbf{Differential abundance analysis of proteins identified 
              ...
              non-significant proteins are indicated. Proteins with a
...
fS5_cap <- c("\\textbf{Functional enrichment analyses of EVs from two DAY286 
              morphologies.} Top 10 significantly enriched biological process 
