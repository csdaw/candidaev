...
(ref:footnote3) [@armenteros2019; @krogh2001]
...
knitr::kable(marker_longlist[ ,-10],
  ...
  footnote(alphabet = c("Protein localisation was inferred from sequence similarity with 
                         \\\\textit{S. cerevisiae} ortholog (ref:footnote1)", 
                        "Protein localisation was predicted using DeepLoc-1.0 (ref:footnote2)", 
                        "Presence of transmembrane domains and signal peptide predicted with TMHMM v2.0 
                         and SignalP 5.0 respectively (ref:footnote3)"), 
           escape = FALSE)
