...
f5_cap <- "\\textbf{Identification of commonly enriched EV proteins across 
           ...
           presented in the table inset. Full lists of enriched GO terms are 
           available in supplemental File S3. Full lists of the proteins 
           in each cluster are available in supplemental File S5.
```
