...
marker_longlist <- marker_longlist %>% 
  mutate(Protein = protein_desc, 
         VF = c("Y", rep("",3), rep("Y", 2), "", "Y", rep("", 9), rep("Y", 2), 
...
```{r figure3, fig.cap=f3_cap, fig.width=7.1, fig.height=6, cache=TRUE, out.extra='trim={0 2cm 0 0},clip'}
...
```{r figure5, fig.cap='heatmap etc.', fig.height=6}
# load f5c
...
```{r figure6, fig.cap='Marker venns', fig.width=2.5, fig.height=4}
ggarrange(f6a, f6b, 
          labels = c("A", "B"), 
          ncol = 1,
          nrow = 2)
