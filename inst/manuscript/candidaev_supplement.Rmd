...
```{r figureS5, fig.cap=fS5_cap, fig.height=7, fig.width=7, fig.path='figures/', dev=c('pdf', 'postscript', 'tiff'), dev.args=fS5_args, dpi=600}
fS5_cap <- c("\\textbf{MAIN} Sub.")
