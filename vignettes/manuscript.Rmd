...
f3a2 <- plot_volcano(data = yeast_res, 
  ...
  scale_colour_manual(labels = c("EV enriched (80)", "WCL enriched (109)", "Not significant (318)"), 
...
```{r figure3, fig.cap='Volcano plots', fig.width=7.1, fig.height=6, cache=TRUE}
# ggarrange(ggarrange(f3a1, f3a2, 
#                     labels = c("A", ""), 
#                     ncol = 2, 
#                     nrow = 1, 
#                     widths = c(1,1.5)), 
...
```{r figure4, fig.cap='Combined comparison', fig.width=7.1, fig.height=7}
...
```{r figure6, fig.cap='Marker venns', fig.width=5, fig.height=2.5}
