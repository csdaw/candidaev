...
f4a <- plot_mds(f4a_data) + 
  geom_text(aes(label = colnames(f5a_data)), hjust = 1.2, vjust = 0.5)

# figure 5b 4 way venn
f4b_comp <- list("DAY286 Y" = rownames(y_ev), 
...
```{r figure4, fig.cap='Combined comparison', fig.width=7.2, fig.height=4}
