...
marker_longlist <- marker_longlist %>% 
  mutate(Function = function_desc1, 
         VDM = c("Y", rep("",3), rep("Y", 2), "", "Y", rep("", 8), rep("Y", 2), 
                 ...
                 "Y", rep("", 7), "Y"), 
         pack_row = c(4, rep(1,3), rep(4,2), 1, 2, rep(1,3), rep(1,3), 3, 2, 
                      rep(4,2), 1, rep(2,2), 3, 1, rep(4,2), 1, rep(4,3), 1, 
                      3, rep(1,3), 4, 1, 1, 2, 1, 2, 2, 2, 4)) %>% 
  arrange(pack_row)
...
knitr::kable(marker_longlist[ ,-10],
  ...
  pack_rows("Golgi, ER, vacuole", 21, 28) %>% 
...
f2a2 <- plot_venn(list("EV" = atcc9_ev, "WCL" = atcc9_w), 
                  use_uniprot = TRUE, type = "plot", 
                  fontfamily = "sans",
                  cex = 0.8,
                  cat.fontfamily = "sans", 
...
f2a3 <- plot_venn(list("EV" = atcc1_ev, "WCL" = atcc1_w), 
                  use_uniprot = TRUE, type = "plot", 
                  fontfamily = "sans", 
                  cex = 0.8,
                  cat.fontfamily = "sans",
...
f3_a9 <- plot_go_bar(f3_a9_go_table, c(1:4, 35,37:38,42, 55:56,58:59), f3_pal) + 
  annotate("text", x = 12, y = 70, label = "bold('ATCC90028')", parse = TRUE)

f3_a1 <- plot_go_bar(f3_a1_go_table, c(1:4, 63,65:67, 88:91), f3_pal) + 
...
# pdf(file = "figures/figure5_htmp.pdf", width = 1.7, height = 4)
