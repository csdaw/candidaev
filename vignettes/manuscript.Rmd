...
(ref:footnote3a) [@armenteros2019; @krogh2001]

```{r markerTable}
tab1_cap <- "\\textbf{Candida protein biomarkers for \\textit{C. albicans} EVs.} 
             ...
             according to UniProtKB. \`\`VD\" shows whether a protein has previously been detected in 
             vesicle-depleted culture media (i.e. it may also be present in the soluble secretome) 
             (ref:table1). Underlined proteins are those identified as the best candidates for 
...
knitr::kable(marker_longlist[ ,-10],
  ...
  footnote(alphabet = c("Protein localisation was inferred from sequence similarity with 
                        ...
                        "Presence of transmembrane domains and signal peptide was predicted 
                         using TMHMM v2.0 and SignalP 5.0 respectively (ref:footnote3a).\n
                         SUR7 is predicted to have 3 transmembrane domains and a signal peptide by 
                         the tool Phobius (ref:footnote3b, which is used for its UniProtKB annotation."), 
           escape = FALSE, 
           threeparttable = TRUE)
