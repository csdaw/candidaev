...
plot_numbers2(atcc_lfq)
```
As it typical for shotgun proteomics data, the proteins in this data set 
...
Next most abundant proteins that are only detected in ATCC10231 EVs and not 
in ATCC10231 WCL can be identified.
...
htmp2 <- ggpubr::as_ggplot(grid::grid.grabExpr(htmp2)) + 
