...
f1_args <- list(tiff = list(type = "cairo"))
```
...
f2_args <- list(tiff = list(type = "cairo"))
```
...
f3_args <- list(tiff = list(type = "cairo"))
```
...
f4_args <- list(tiff = list(type = "cairo"))
```
...
f5_args <- list(tiff = list(type = "cairo"))
```
...
f6_args <- list(tiff = list(type = "cairo"))
```
...
f7_args <- list(tiff = list(type = "cairo"))
```
...
f8_args <- list(tiff = list(type = "cairo"))
```
