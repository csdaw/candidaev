...
<!-- Ref (57) is The UniProt Consortium 2019 -->
<!-- Ref (58) is Tsirigos et al. 2015 -->
...
knitr::kable(marker_longlist2[ ,-9],
  ...
  footnote(alphabet = c("Protein localisation was inferred from sequence 
                        ...
                        UniProt reference proteome UP000000559 (57).", 
                        "Presence of transmembrane domains and absence of a 
                        signal peptide was predicted using TOPCONS2 (58).",
...
```{r figure1, fig.width=7.1, fig.height=4}
# draw figure 1
ggarrange(f1a, 
          ggarrange(f1b, f1c, 
                    labels = c("B", "C"), 
...
```{r figure2, fig.width=7.1, fig.height=6}
# draw figure 2
...
```{r figure3, fig.width=7.2, fig.height=6}
# draw figure 3
...
```{r figure4, fig.width=7.1, fig.height=5}
...
```{r figure6, fig.width=2.5, fig.height=4}
ggarrange(f6a, f6b, 
          labels = c("A", "B"), 
          ncol = 1,
          nrow = 2)
...
```{r figure7, fig.width=4, fig.height=3.6}
...
```{r figure8, fig.width=7.2, fig.height=6}
