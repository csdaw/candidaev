...
# levels = yeast, biofilm, ATCC90028, ATCC10231
st_pal <- c("#E69F00", "#CC79A7", "#56B4E9", "#009E73")
...
marker_longlist <- marker_longlist %>% 
  mutate(Function = protein_desc, 
         VDS = c("Y", rep("",3), rep("Y", 2), "", "Y", rep("", 8), rep("Y", 2), 
...
f2b <- nta_bioavg %>% 
  ...
  scale_colour_manual(values = rev(st_pal), 
...
f2c <- nta_total %>% 
  ggboxplot(x = "Strain", y = "part_per_prot", 
            color = "Strain", palette = rev(st_pal), add = "jitter", 
            shape = 15,
...
f3a2 <- plot_venn(list("EV" = b_ev, "WCL" = b_wcl), 
                  use_uniprot = TRUE, type = "plot", 
                  fontfamily = "sans", 
                  cex = 0.8, 
                  cat.fontfamily = "sans", 
...
f3a3 <- plot_venn(list("EV" = atcc9_ev, "WCL" = atcc9_w), 
                  use_uniprot = TRUE, type = "plot", 
                  fontfamily = "sans",
                  cex = 0.8,
                  cat.fontfamily = "sans", 
...
f3a4 <- plot_venn(list("EV" = atcc1_ev, "WCL" = atcc1_w), 
                  use_uniprot = TRUE, type = "plot", 
                  fontfamily = "sans", 
                  cex = 0.8,
                  cat.fontfamily = "sans",
...
f5_cap <- "This is a figure caption."
```
...
f6_cap <- "\\textbf{Identification of commonly enriched EV proteins across different \\textit{C. albicans} strains.} 
           Heatmap of proteins (n = 403) identified in all four EV samples (venn overlap in Figure \\@ref(fig:figure4)C. 
           Each column 
...
f7_cap <- "\\textbf{Identification of common signficantly enriched or exclusive \\textit{C. albicans} 
           ...
           protein marker candidates and 52 negative candidates can be found in Table  and 
