...
The raw proteinGroups.txt file on which these analyses are based can be 
accessed [here](). 
...
[^1]: Each protein group comprises the group of proteins that could be 
...
```{r atccVenn, fig.cap=atccVenn_cap, fig.small=TRUE}
...
atccVenn_cap <- "This is a figure caption. This is the second sentence."
```
...
#   as.matrix()
# 
# plot_heatmap2(atcc_htmp, atcc_exp, uniprot, kmeans = TRUE, k = 5, 
#               clustering_distance = "euclidean", show_row_names = FALSE)
...
htmp3_params <- list(title = "legend title", 
...
plot_heatmap(atcc_htmp3, 
             ...
             colour_lims = c(-4,4), 
             heatmap_legend_param = htmp3_params)
```
...
upset(fromList(marker_comp2), 
      ...
      order.by = "degree")
marker_comp_tab2 <- plot_venn(vlist = marker_comp2, 
                              use_uniprot = FALSE, type = "list")
