...
atcc_overall <- get_results(efit = atcc_efit, mat = atcc_de, type = "overall")

# extract results for individual comparisons defined in atcc_contrasts
atcc_ind <- get_results(efit = atcc_efit, mat = atcc_de, type = "individual")
