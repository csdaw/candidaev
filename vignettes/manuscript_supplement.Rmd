...
```{r figureS1, fig.cap=fS1_cap, fig.height=4, fig.width=4}

fS1_cap <- c("This is a really, really, really, really, really, really, really, 
...
tabS1_cap <- "This is the caption for tabS1"
...
```{r tableS2}
tabs2_cap <- "This is a table caption"
...
knitr::kable(wcl_longlist[, -10], 
  ...
  add_header_above(c(" " = 2, "log\\\\textsubscript{2}(fold change) EV vs Cell" = 4, " " = 2), escape = FALSE) %>% 
