...
f4_y <- plot_go_bar(f4_y_go_table, c(1:4, 49,52:53,55, 77,79:81), f4_pal) + 
  annotate("text", x = 1.5, y = 65, label = "bold('DAY286 yeast')", parse = TRUE) + 
  labs(fill = "GO domain") + 
  theme(legend.text = element_text(size = 10), 
        legend.title = element_text(size = 10))

f4_b <- plot_go_bar(f4_b_go_table, c(1:4, 69,71:73, 96:97, 100:101), f4_pal) + 
  annotate("text", x = 1.5, y = 60, label = "bold('DAY286 biofilm')", parse = TRUE)

f4_a9 <- plot_go_bar(f4_a9_go_table, c(1:4, 35,37:38,42, 55:56,58:59), f4_pal) + 
  annotate("text", x = 1.5, y = 70, label = "bold('ATCC90028')", parse = TRUE)

f4_a1 <- plot_go_bar(f4_a1_go_table, c(1:4, 63,65:67, 88:91), f4_pal) + 
  annotate("text", x = 1.5, y = 70, label = "bold('ATCC10231')", parse = TRUE)
